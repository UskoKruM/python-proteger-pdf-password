# Protección de un PDF por contraseña (password), usando Python y PyPDF2

Aprende a proteger (encriptar) un archivo PDF usando un script de Python y la librería PyPDF2. Conoce cómo crear un PDF protegido (por contraseña) usando el lenguaje de programación Python.
